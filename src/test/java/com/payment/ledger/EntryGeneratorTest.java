...
/**
 * 分录生成。<b>这些用例就是你手写过的那些分录题。</b>
 */
class EntryGeneratorTest {

    private final EntryGenerator generator = new EntryGenerator();
    ...
    void recharge() {
        List<EntryCommand> entries = generator.generate(
    ...
    void allGeneratedEntriesAreBalanced() {
        ...
        for (BookingRequest r : cases) {
            List<EntryCommand> entries = generator.generate(r);
